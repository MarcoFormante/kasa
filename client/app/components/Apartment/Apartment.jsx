        ...
        <article className="apt-card">
            <Link href={"/locations/3"}>
                ...
                <div className="apt-card-details-section">
                    <div>
                        <h3 itemProp="name">Appartement cosy</h3>
            ...
            <button className="fav-btn">
                    <svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.7" d="M0.5 3.24408C0.5 6.93608 5.3 9.41608 5.3 9.41608C5.3 9.41608 10.1 6.93808 10.1 3.24408C10.1 1.73008 8.872 0.502078 7.358 0.502078C6.534 0.502078 5.804 0.872078 5.3 1.44808C4.798 0.872078 4.066 0.502078 3.242 0.502078C1.728 0.500078 0.5 1.72808 0.5 3.24408Z" fill="#565656"/>
